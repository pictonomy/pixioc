...
package net.pixlib.ioc.control 
{
	 ...
	 */
	public class PXBuildArray extends PXAbstractCommand
	{
		override protected function onExecute( event : Event = null ) : void
		{
			...
			if ( args == null ) array = new Array(); 
			else array = args.concat();

			if ( array.length <= 0 ) logger.warn( this + ".build(" + args + ") returns an empty Array.", this );

			constructor.result = array;
			fireCommandEndEvent();
		}
	}
}